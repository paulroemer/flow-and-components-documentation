...
TIP: Watch the https://vaadin.com/training/course/view/v10-intro[Vaadin 10+: Intro] free training video to learn more about the Vaadin framework, basic Vaadin application architecture and how Vaadin components work.
...
** Lets you choose either basic HTTP(S) or WebSocket communications protocol for building real-time applications.
